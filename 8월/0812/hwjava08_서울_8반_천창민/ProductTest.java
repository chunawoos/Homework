	   ...
	   do { //String isbn, String name, String company, int price, int stock, int weight
		 ...
		 switch(num) {
		   ...
		   case SEARCH_RefVolume://7:
			   ...
			   ArrayList<Product> list7 = new ArrayList<>();
			   try {
				   list7 = mgr.searchRefVolume(400); 
				   print(list7);	
		   ...
		   case SEARCH_TVSize://8:
			   ...
			   ArrayList<Product> list8 = new ArrayList<>();
			   try {
				   list8 = mgr.searchTvSize(50);
				   print(list8);
			   } catch(ProductNotFoundException e) {
				   System.out.println(e.getMessage());
			   }
		   ...
		   case SEARCH_Change://9:
			   ...
			   try {
				   ...
				   prod9 = mgr.searchIsbn(changeIsbn);
				   print(prod9);
			   } catch(CodeNotFoundException e) {
				   System.out.println(e.getMessage());
			   }
